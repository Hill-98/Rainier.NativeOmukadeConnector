...
namespace Rainier.NativeOmukadeConnector
{
    ...
    {
        internal const string VERSION_STRING = "Native Omukade Connector \"NOC\" 2.2.11 (\"Auditioning Apple Rev1 Hill-98 mod\")";
        ...
        private void Awake()
        {
            ...
            if (!Environment.GetCommandLineArgs().Contains("--enable-omukade") && Environment.GetEnvironmentVariable("OMUKADE_CONNECTOR_CONFIG") == null)
            {
